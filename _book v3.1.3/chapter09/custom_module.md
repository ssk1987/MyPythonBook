...
> 在很多时候，我们可以自己定义属于自己的模块，在日常工作中可以直接拿来使用。
...
### 我们把以上的代码分成一个逻辑处理模块(DoubleListHelper.py)，一个调用入口(main.py)


![](http://www.python87.com/uploads/allimg/191126/1-19112614401WV.jpg)
